...
int main(int argc, char *argv[])
{
		...
		CLIENT_INFO client_info[MAX_CLNT] = {{0,-1,"","KKH_PI1","PASSWD"}, \
				{0,-1,"","KKH_UBU","PASSWD"},  {0,-1,"","KKH_STM","PASSWD"}, \
				{0,-1,"","KKH_PI3","PASSWD"},  {0,-1,"","KKH_PI2","PASSWD"}, \
				{0,-1,"","KKH_STL","PASSWD"},  {0,-1,"","KKH_ARD","PASSWD"}, \
				{0,-1,"","KKH_BT","PASSWD"},  {0,-1,"","9","PASSWD"}, \
